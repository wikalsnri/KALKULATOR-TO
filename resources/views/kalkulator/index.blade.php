    ...
    <div class="container">
        <div class="calculator-container">
            ...
            <form action="{{ route('proses.store') }}" method="post">
                ...
                <div class="form-group text-center">
                    ...
                    <input type="submit" class="btn btn-success" value="Bagi" name="op">
                    <input type="submit" class="btn btn-warning" value="Kali" name="op">
        ...
        <div class="calculator-container">
            ...
            <form name="form1" action="" method="post">
                <input type="text" name="txt1" class="form-control mb-3">
